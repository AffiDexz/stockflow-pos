      ...
      {!order && (
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          ...
          <button
            onClick={reserve}
            disabled={reserving}
            className="w-full inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700 disabled:opacity-50"
          >
