      ...
      <div className="w-full max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter') navigate(`/products?q=${encodeURIComponent(e.target.value)}`);
            }}
            className="w-full bg-slate-100 rounded-lg pl-10 pr-4 py-2 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
          />
        </div>
      </div>
